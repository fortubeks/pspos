      ...
      <div class="card">
        <div class="card-body p-3">
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                <p class="text-sm mb-0 text-capitalize font-weight-bold">PMS Sales</p>
                <h5 class="font-weight-bolder mb-0">
                {{Helper::getDashboardSales()->get('pms') ?? Helper::formatCurrency(0.00)}}
      ...
      <div class="card">
        <div class="card-body p-3">
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                <p class="text-sm mb-0 text-capitalize font-weight-bold">AGO</p>
                <h5 class="font-weight-bolder mb-0">
                {{Helper::getDashboardSales()->get('ago') ?? Helper::formatCurrency(0.00)}}
      ...
      <div class="card">
        <div class="card-body p-3">
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                <p class="text-sm mb-0 text-capitalize font-weight-bold">Supermarket</p>
                <h5 class="font-weight-bolder mb-0">
                {{Helper::getDashboardSales()->get('supermaket') ?? Helper::formatCurrency(0.00)}}
            ...
            <table class="table align-items-center justify-content-center mb-0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <p class="text-sm font-weight-bold mb-0 text-right">{{Helper::getDashboardSales()->get('supermaket') ?? Helper::formatCurrency(0.00)}}</p>
                  </td>
                  <td class="align-middle"></td>
                  <td class="align-middle"></td>
                </tr>
