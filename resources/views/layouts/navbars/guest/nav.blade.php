    ...
    <div class="collapse navbar-collapse" id="navigation">
      <ul class="navbar-nav mx-auto">
        @if (auth()->user())
            ...
            <li class="nav-item">
            <a class="nav-link me-2" href="{{ url('settings') }}">
      ...
      <ul class="navbar-nav d-lg-block d-none">
        <li class="nav-item">
          <a href="https://fortranhouse.com" target="_blank" class="btn btn-sm btn-round mb-0 me-1 bg-gradient-{{ (Request::is('static-sign-up') ? 'light' : 'dark') }}">Contact us</a>
        </li>
      </ul>
    </div>
  </div>
