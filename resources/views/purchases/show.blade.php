...
<div>
    ...
    <div class="card">
        <div class="card-header pb-0 px-3">
            <h6 class="mb-0">{{ __('Purchase') }}</h6>
        </div>
        <div class="card-body pt-4 p-3">
            <form action="{{url('/pumps/'.$pump->id)}}" method="POST" role="form text-left">
                @csrf
                @if($errors->any())
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="@error('qty')border border-danger rounded-3 @enderror">
                                <input class="form-control" value="{{$pump->name}}" type="text" name="name">
                                    @error('name')
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="@error('product')border border-danger rounded-3 @enderror">
                                <select class="form-select form-control" id="product" data-product="{{$pump->product->id}}" name="product">
