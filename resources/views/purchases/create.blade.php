            ...
            <div class="card-body pt-4 p-3">
                <form action="{{url('/purchases')}}" method="POST" role="form text-left">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="@error('product')border border-danger rounded-3 @enderror">
                                    <select class="form-select form-control" id="product" data-price="0" onchange="setPrice(this)" name="product">
                                        ...
                                        <option data-price="{{$product->branch_product()->pivot->cost}}" value="{{$product->id}}">{{$product->name.' @ '.$product->branch_product()->pivot->price.' per KG'}}</option>
                                        @endforeach
                                    </select>
                                    @error('product')
                                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="user-name" class="form-control-label">Quantity in KG</label>
