...
<div>
    ...
    <div class="card">
        ...
        <div class="card-body pt-4 p-3">
            <form action="{{url('/products/'.$product->id)}}" method="POST" role="form text-left">
                @csrf
                @if($errors->any())
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="@error('qty')border border-danger rounded-3 @enderror">
                                <input class="form-control" value="{{$product->name}}" type="text" placeholder="Product Name eg. AGO" name="name">
                                    @error('name')
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="@error('cost')border border-danger rounded-3 @enderror">
                                <input class="form-control" value="{{$product->branch_product()->pivot->cost}}" type="number" placeholder="Cost" name="cost">
                                    @error('cost')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="@error('price')border border-danger rounded-3 @enderror">
                                <input class="form-control" value="{{$product->branch_product()->pivot->price}}" type="number" name="price">
                                    @error('price')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                            </div>
