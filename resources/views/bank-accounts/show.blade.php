...
<div>
    ...
    <div class="card">
        <div class="card-header pb-0 px-3">
            <h6 class="mb-0">{{ __('Bank Account') }}</h6>
        </div>
        <div class="card-body pt-4 p-3">
            <form action="{{url('/bank-accounts/'.$bank_account->id)}}" method="POST" role="form text-left">
                @csrf
                @if($errors->any())
                ...
                <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="@error('qty')border border-danger rounded-3 @enderror">
                                <input class="form-control" type="text" value="{{$bank_account->name}}" name="name">
                                    @error('name')
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="@error('product')border border-danger rounded-3 @enderror">
                                <select id="bank" class="form-select form-control" data-bank="{{$bank_account->bank_name}}" name="bank_name">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="@error('product')border border-danger rounded-3 @enderror">
                                <input class="form-control" type="text" value="{{$bank_account->number}}" name="number">
                                    @error('product')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                            </div>
