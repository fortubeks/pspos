...
<div>
    ...
    <div class="card">
        <div class="card-header pb-0 px-3">
            <h6 class="mb-0">{{ __('Attendant') }}</h6>
        </div>
        <div class="card-body pt-4 p-3">
            <form action="{{url('/attendants/'.$attendant->id)}}" method="POST" role="form text-left">
                @csrf
                @if($errors->any())
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="@error('qty')border border-danger rounded-3 @enderror">
                                <input class="form-control" value="{{$attendant->name}}" type="text" name="name">
                                    @error('name')
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="@error('cost')border border-danger rounded-3 @enderror">
                                <input class="form-control" type="text" value="{{$attendant->phone}}" name="phone">
                                    @error('cost')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                            </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="@error('qty')border border-danger rounded-3 @enderror">
                                <input class="form-control" type="text" value="{{$attendant->address}}" name="address">
                                    @error('name')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="@error('cost')border border-danger rounded-3 @enderror">
                                <input class="form-control" type="text" value="{{$attendant->other_details}}" name="other_details">
                                    @error('cost')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                            </div>
