...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::resources([
		...
		'customer-sales' => App\Http\Controllers\CustomerSaleController::class,
		'customer-payments' => App\Http\Controllers\CustomerPaymentController::class,
		'suppliers' => App\Http\Controllers\SupplierController::class,
		'products' => App\Http\Controllers\ProductsController::class,
		'pumps' => App\Http\Controllers\PumpsController::class,
		'tanks' => App\Http\Controllers\TankController::class,
		'tank-readings' => App\Http\Controllers\TankReadingController::class,
		'expenses' => App\Http\Controllers\ExpenseController::class,
		'banking-records' => App\Http\Controllers\BankingRecordController::class,
		'bank-accounts' => App\Http\Controllers\BankAccountController::class,
		'expense-categories' => App\Http\Controllers\ExpenseCategoryController::class,
		'purchases' => App\Http\Controllers\PurchasesController::class,
